...
from (
	...
	from pdb_VT_ChronicPain..Com_MemberSummary_TTL_UBHonly	m
...
--Dynamic Pivot:
if OBJECT_ID ('pdb_VT_ChronicPain..Com_tmpPvtDiag_Matt_UBHonly') is not null begin drop table pdb_VT_ChronicPain..Com_tmpPvtDiag_Matt_UBHonly	End;
...
into pdb_VT_ChronicPain..Com_tmpPvtDiag_Matt_UBHonly
from
...
--drop table #Com_SRT_Memberspvt_Matt_UBHonly
...
into #Com_SRT_Memberspvt_Matt_UBHonly
from pdb_VT_ChronicPain..Com_MemberSummary_TTL_UBHonly		a
left join pdb_VT_ChronicPain..Com_tmpPvtDiag_Matt_UBHonly		b on a.Indv_Sys_Id = b.Indv_Sys_Id
where wChronicPain = 1
--385
select count(*) from pdb_VT_ChronicPain..Com_MemberSummary_TTL_UBHonly where wChronicPain = 1
-----------------------------------------------------------------------------------------------

--drop table pdb_VT_ChronicPain..Com_SRT_Memberspvt_Matt
select * into pdb_VT_ChronicPain..Com_SRT_Memberspvt_Matt_UBHonly from #Com_SRT_Memberspvt_Matt_UBHonly
...
add DiagV2_SRTFlag smallint

update pdb_VT_ChronicPain..Com_MemberSummary_TTL_UBHonly set 
DiagV2_SRTFlag = isnull(b.Diag_CPInt_SRTFlag,0)
from pdb_VT_ChronicPain..Com_MemberSummary_TTL_UBHonly		a
